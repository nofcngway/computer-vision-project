...
class ManualBinarization:
    ...
    def sauvola(img, window_size=25, k=0.34):
        return ManualBinarization.niblack_sauvola_formula(img, window_size, k, method='sauvola')
    
    @staticmethod
    def niblack(img, window_size=25, k=-0.2):
        return ManualBinarization.niblack_sauvola_formula(img, window_size, k, method='niblack')
